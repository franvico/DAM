 ...
 * CAMBIO 8 : Adjudico estos monitores a los contructores de Clasificador y Cons
 * CAMBIO 9 : Declaro las secciones de código que han de sincronizarse (usando syncronized) en las clases Clasificador y Cons, dependiendo si leen o escriben
 * 			  sobre pares o impares se sincronizan usando un monitor u otro
 * NOTA : Creo que está todo bien sincronizado pero hay un fallo de acceso a las colecciones que está dando error -> no me da tiempo a solucionarlo 
 * 
 * */
public class Main {
