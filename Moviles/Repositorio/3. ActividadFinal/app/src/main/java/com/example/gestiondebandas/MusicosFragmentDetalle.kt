...
class MusicosFragmentDetalle : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        musico?.let {
            ...
            view.findViewById<EditText>(R.id.valorNombre).hint = it.musico.nombre
            view.findViewById<TextView>(R.id.labelApellido).text = "Apellido"
            view.findViewById<EditText>(R.id.valorApellido).hint = it.musico.apellido
            view.findViewById<TextView>(R.id.labelTipoInstrumento).text = "Instrumento"
            view.findViewById<TextView>(R.id.valorTipoInstrumento).text = it.instrumento?.tipo ?: "Sin instrumento"
            view.findViewById<TextView>(R.id.labelNIFBanda).text = "NIF Banda"
            view.findViewById<EditText>(R.id.valorNIFBanda).hint = it.musico.nif_banda.toString()
        }
        ...
        botonModificarMusico.setOnClickListener {
            val nuevoNombreMusico = view.findViewById<EditText>(R.id.valorNombre).text
            val nuevoNombre = nuevoNombreMusico

            if (!nuevoNombre.equals("")) {
                musico?.let {
                    if (!it.musico.nombre.equals(nuevoNombre)) {
                        it.musico.nombre = nuevoNombre.toString()
