...
public class Sede {
	...
	private List<ProyectoSede> proyectosSede;
	...
	public List<ProyectoSede> getProyectosSede() {
		return proyectosSede;
	}

	public void setProyectosSede(List<ProyectoSede> proyectosSede) {
		this.proyectosSede = proyectosSede;
	}
